...
function PopularDiaries() {
  const baseURL =
    "https://kudrchaizgkzyjzrkhhy.supabase.co/storage/v1/object/public/";

  const { data } = useQuery({
    queryKey: ["diariesWithLikes"],
    queryFn: api.diaries.getDiaryWithLikes,
  });
        ...
        <div key={diary.id}>
          <div className="relative group rounded-[8px] bg-whitePoint border-2 border-transparent">
            ...
            <div className="ml-5 flex gap-2 mt-1 z-0 relative">
              ...
              <CommentButton commentsCount={diary.comment.length} />
            </div>
